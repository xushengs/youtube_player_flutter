...
class YoutubePlayerFlags {
  ...
  /// Enable play on background mode or not.
  ///
  /// Default is false.
  final bool playOnBackground;
  ...
  YoutubePlayerFlags copyWith({
    ...
    return YoutubePlayerFlags(
      ...
      playOnBackground: playOnBackground ?? this.playOnBackground,
    );
  }
}
